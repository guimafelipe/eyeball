...
public class SoldierGreen : MonoBehaviour {
	...
	public float shootCD, maxShootCD = 3f, speed = 1f, minDist = 4.5f, t = 0f, floatSpeed = 0.3f, omega = 0.7f;
	...
	IEnumerator PlsDie(){
		...
		gameObject.GetComponent<SoldierGreen> ().enabled = false;
